...
export const settingsMetadata = {
	...
	tag: {
		...
		tomlKey: 'tag',
		label: 'Coinbase Tag',
		description: 'The tag embedded in the coinbase of blocks pogolo produces.',
	...
	disable_vardiff: {
		...
		label: 'Disable Automatic Difficulty Adjustment (VarDiff)',
		description:
	...
	ignore_suggested_difficulty: {
		...
		description: 'Ignore the difficulty a gopher asks for and use the pool’s own value instead.',
		default: false,
	},
	...
	extranonce2_size: {
		...
		subDescription: '⚠ This usually should not be touched. Some gophers are picky about this value.',
		min: 0,
		max: 32,
		step: 1,
		default: 4,
